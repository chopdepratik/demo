...
export const registerTask= async (req, res) => {
    try {
        const {tid,title,description,statuss,dueDate} = req.body;

        if ([tid,title,description,statuss,dueDate].some((field) => typeof field === 'string' && field.trim() === "")) {
...
export const updateTask = async (req, res) => {
    try {
        ...
        task.dueDate= dueDate =dueDate!==undefined? dueDate: task.dueDate;
